...
import { FaArrowRight, FaCheckCircle, FaLightbulb, FaPhoneAlt } from 'react-icons/fa';
    ...
    const offers = [
        {
            ...
            icon: webDevelopment,
            detailedDescription: 'Our Web Development service includes designing and developing responsive, SEO-friendly, and user-centric websites. Whether you need a personal blog, a corporate site, or an eCommerce platform, we have the skills and expertise to bring your vision to life.',
            features: [
        ...
        },
        {
            ...
            icon: appDevelopment,
            detailedDescription: 'We specialize in developing native mobile apps for both Android and iOS platforms. Our team ensures that your app is not only functional but also provides a seamless user experience across devices.',
            features: [
        ...
        },
        {
            ...
            icon: appPublishing,
            detailedDescription: 'We offer app publishing services for both iOS and Android apps. Our team will guide you through the entire process of submitting your app to the App Store and Google Play Store, ensuring a smooth launch.',
            features: [
        ...
        },
        {
            ...
            icon: appPromotion,
            detailedDescription: 'Our app promotion services help you increase your app downloads and boost user engagement. We utilize social media, influencer marketing, and app store optimization (ASO) strategies to ensure maximum visibility.',
            features: [
                'App Store Optimization (ASO)',
        ...
        },
        {
            ...
            icon: adPromotion,
            detailedDescription: 'Our ad promotion service includes digital marketing campaigns, targeted ads, and SEO strategies to help you advertise your business and reach potential customers. We use Google Ads, Facebook, Instagram, and other platforms to create custom campaigns.',
            features: [
        ...
        },
        {
            ...
            icon: lead,
            detailedDescription: 'Our lead generation service helps you capture high-quality leads from various channels. By using forms, landing pages, and social media tools, we ensure that you can effectively collect information from potential customers.',
            features: [
        ...
        },
        {
            ...
            detailedDescription: 'Our testing service ensures that your website or mobile app is free from bugs, errors, and performance issues. We provide manual and automated testing to ensure your product is ready for launch.',
            features: [
                'Functional Testing',
                'Performance Testing',
                'Security Testing',
        ...
        },
        {
            ...
            description: 'Support for Google Play Console and Apple Developer Console.',
            icon: consoleImage,
            detailedDescription: 'We provide support for managing your apps on the Google Play Console and Apple Developer Console. From app submission to analytics, our team helps you maintain and optimize your apps for both stores.',
            features: [
                                ...
                                <div className="space-y-3 text-gray-200">
                                    <div className='flex flex-col md:flex-row justify-between text-xs'>
                                        ...
                                        <div className="mb-2 md:mb-0">
                                            <h4 className="font-semibold text-lg text-blue-400 flex items-center gap-2"><MdFeaturedPlayList />Features:</h4>
                                            <ul className="space-y-2">
                                                {modalContent.features?.map((feature, index) => (
                                                    <li key={index} className="flex items-center gap-2">
                                                        <FaCheckCircle className="text-green-500" /> {/* Green check icon */}
                                                        {feature}
                                                    </li>
                                                ))}
                                            </ul>
                                        ...
                                        {/* Benefits */}
                                        <div className="mb-2 md:mb-0">
                                            <h4 className="font-semibold text-lg text-blue-400 flex items-center gap-2"><FaLightbulb /> Benefits:</h4>
                                            <ul className=" space-y-2">
