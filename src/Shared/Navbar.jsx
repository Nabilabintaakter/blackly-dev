      ...
      <Container>
        <div className="navbar p-0">
          ...
          <div className="navbar-end">
            <button className="bg-white text-black text-sm md:text-base hover:bg-transparent hover:text-white transition-all duration-300 border-[1px] border-white hover:border-white/50 font-semibold px-2 py-1 md:py-2 md:px-4 rounded-full flex items-center cursor-pointer" onClick={() => window.open('https://wa.me/8801622559988', '_blank')}>
